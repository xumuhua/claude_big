...
A轨（永持底仓）: 纳指50% + 黄金50%
  ...
  └─ 震荡态 RSI 网格
B轨（高波增强）: 科创50/恒生ETF/创业板ETF —— 三层入场(V反早鸟/标准筑底/W2主升浪)
  （恒生科技513180、科创板ETF588060 20260908哥哥指令移出候选池——科创类只留科创50；两油20260814随2027退市移出）
...
- 当前持仓（09-07 信号）：黄金 50% + 恒科 15% + 现金 35%（恒科 20260908 哥哥指令清仓，次日 09:30 执行全清）
